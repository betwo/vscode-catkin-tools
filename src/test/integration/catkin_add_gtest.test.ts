	...
	describe('Workspace catkin_add_gtest', () => {
		describe("catkin_add_gtest", () => {
			...
			it("#package_a tests test result is detected", async () => {
				...
				console.log("!!!!!!!!!!!!!!!!!!");
				console.log(`${succeeding_test_run.items_started.length}`);
				console.log(`${succeeding_test_run.items_passed.length}`);
				console.log(`${succeeding_test_run.items_skipped.length}`);
				console.log(`${succeeding_test_run.items_errored.length}`);
				console.log(`${succeeding_test_run.items_failed.length}`);
				console.log("> !!!!!!!!!!!!!!!!!!");
